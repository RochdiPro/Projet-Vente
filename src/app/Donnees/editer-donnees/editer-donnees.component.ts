...
@Component({
  selector: 'app-editer-donnees',
  templateUrl: './editer-donnees.component.html',
  styleUrls: ['./editer-donnees.component.scss']
})
export class EditerDonneesComponent implements OnInit {
  liste_categorie: any;
  categorie: any;
  catDonnees: any;
  nom_categorie: any;
  ...
  constructor(public donneesService: DonneesService, private fb: FormBuilder) {
